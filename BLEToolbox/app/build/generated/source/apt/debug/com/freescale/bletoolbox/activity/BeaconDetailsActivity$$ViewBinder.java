...
public class BeaconDetailsActivity$$ViewBinder<T extends com.freescale.bletoolbox.activity.BeaconDetailsActivity> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131493094, "field 'mManufacture'");
    target.mManufacture = finder.castView(view, 2131493094, "field 'mManufacture'");
    view = finder.findRequiredView(source, 2131493095, "field 'mUuid'");
    target.mUuid = finder.castView(view, 2131493095, "field 'mUuid'");
    view = finder.findRequiredView(source, 2131493096, "field 'mDataA'");
    target.mDataA = finder.castView(view, 2131493096, "field 'mDataA'");
    view = finder.findRequiredView(source, 2131493097, "field 'mDataB'");
    target.mDataB = finder.castView(view, 2131493097, "field 'mDataB'");
    view = finder.findRequiredView(source, 2131493098, "field 'mDataC'");
    target.mDataC = finder.castView(view, 2131493098, "field 'mDataC'");
    view = finder.findRequiredView(source, 2131493099, "field 'mRssi'");
    target.mRssi = finder.castView(view, 2131493099, "field 'mRssi'");
  }
