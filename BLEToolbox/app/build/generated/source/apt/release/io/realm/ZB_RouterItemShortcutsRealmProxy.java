...
public class ZB_RouterItemShortcutsRealmProxy extends ZB_RouterItemShortcuts
    ...
    public static Table initTable(ImplicitTransaction transaction) {
        if (!transaction.hasTable("class_ZB_RouterItemShortcuts")) {
            Table table = transaction.getTable("class_ZB_RouterItemShortcuts");
        ...
        return transaction.getTable("class_ZB_RouterItemShortcuts");
    }
    ...
    public static void validateTable(ImplicitTransaction transaction) {
        if (transaction.hasTable("class_ZB_RouterItemShortcuts")) {
            ...
            for (String fieldName : getFieldNames()) {
                ...
                if (index == -1) {
                    throw new RealmMigrationNeededException(transaction.getPath(), "Field '" + fieldName + "' not found for type ZB_RouterItemShortcuts");
                }
            ...
            throw new RealmMigrationNeededException(transaction.getPath(), "The ZB_RouterItemShortcuts class is missing from the schema for this Realm.");
        }
    }
    ...
    public static ZB_RouterItemShortcuts createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        ZB_RouterItemShortcuts obj = realm.createObject(ZB_RouterItemShortcuts.class);
    ...
    public static ZB_RouterItemShortcuts createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        ZB_RouterItemShortcuts obj = realm.createObject(ZB_RouterItemShortcuts.class);
        reader.beginObject();
    ...
    public static ZB_RouterItemShortcuts copyOrUpdate(Realm realm, ZB_RouterItemShortcuts object, boolean update, Map<RealmObject,RealmObjectProxy> cache) {
    ...
    public static ZB_RouterItemShortcuts copy(Realm realm, ZB_RouterItemShortcuts newObject, boolean update, Map<RealmObject,RealmObjectProxy> cache) {
        ZB_RouterItemShortcuts realmObject = realm.createObject(ZB_RouterItemShortcuts.class);
    ...
    static ZB_RouterItemShortcuts update(Realm realm, ZB_RouterItemShortcuts realmObject, ZB_RouterItemShortcuts newObject, Map<RealmObject, RealmObjectProxy> cache) {
        realmObject.setStrCommand(newObject.getStrCommand() != null ? newObject.getStrCommand() : "");
        realmObject.setStrValue(newObject.getStrValue() != null ? newObject.getStrValue() : "");
        realmObject.setStrTime(newObject.getStrTime() != null ? newObject.getStrTime() : "");
        return realmObject;
    ...
    public String toString() {
        ...
        StringBuilder stringBuilder = new StringBuilder("ZB_RouterItemShortcuts = [");
    ...
    public boolean equals(Object o) {
        ...
        ZB_RouterItemShortcutsRealmProxy aZB_RouterItemShortcuts = (ZB_RouterItemShortcutsRealmProxy)o;

        String path = realm.getPath();
        String otherPath = aZB_RouterItemShortcuts.realm.getPath();
        if (path != null ? !path.equals(otherPath) : otherPath != null) return false;;

        String tableName = row.getTable().getName();
        String otherTableName = aZB_RouterItemShortcuts.row.getTable().getName();
        if (tableName != null ? !tableName.equals(otherTableName) : otherTableName != null) return false;

        if (row.getIndex() != aZB_RouterItemShortcuts.row.getIndex()) return false;
