...
public class ZB_EndDeviceItemShortcutsRealmProxy extends ZB_EndDeviceItemShortcuts
    ...
    public static Table initTable(ImplicitTransaction transaction) {
        if (!transaction.hasTable("class_ZB_EndDeviceItemShortcuts")) {
            Table table = transaction.getTable("class_ZB_EndDeviceItemShortcuts");
        ...
        return transaction.getTable("class_ZB_EndDeviceItemShortcuts");
    }
    ...
    public static void validateTable(ImplicitTransaction transaction) {
        if (transaction.hasTable("class_ZB_EndDeviceItemShortcuts")) {
            ...
            for (String fieldName : getFieldNames()) {
                ...
                if (index == -1) {
                    throw new RealmMigrationNeededException(transaction.getPath(), "Field '" + fieldName + "' not found for type ZB_EndDeviceItemShortcuts");
                }
            ...
            throw new RealmMigrationNeededException(transaction.getPath(), "The ZB_EndDeviceItemShortcuts class is missing from the schema for this Realm.");
        }
    }

    public static String getTableName() {
        return "class_ZB_EndDeviceItemShortcuts";
    }
    ...
    public static ZB_EndDeviceItemShortcuts createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        ZB_EndDeviceItemShortcuts obj = realm.createObject(ZB_EndDeviceItemShortcuts.class);
    ...
    public static ZB_EndDeviceItemShortcuts createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        ZB_EndDeviceItemShortcuts obj = realm.createObject(ZB_EndDeviceItemShortcuts.class);
        reader.beginObject();
    ...
    public static ZB_EndDeviceItemShortcuts copyOrUpdate(Realm realm, ZB_EndDeviceItemShortcuts object, boolean update, Map<RealmObject,RealmObjectProxy> cache) {
    ...
    public static ZB_EndDeviceItemShortcuts copy(Realm realm, ZB_EndDeviceItemShortcuts newObject, boolean update, Map<RealmObject,RealmObjectProxy> cache) {
        ZB_EndDeviceItemShortcuts realmObject = realm.createObject(ZB_EndDeviceItemShortcuts.class);
    ...
    static ZB_EndDeviceItemShortcuts update(Realm realm, ZB_EndDeviceItemShortcuts realmObject, ZB_EndDeviceItemShortcuts newObject, Map<RealmObject, RealmObjectProxy> cache) {
        realmObject.setStrCommand(newObject.getStrCommand() != null ? newObject.getStrCommand() : "");
        realmObject.setStrValue(newObject.getStrValue() != null ? newObject.getStrValue() : "");
        realmObject.setStrTime(newObject.getStrTime() != null ? newObject.getStrTime() : "");
        return realmObject;
    ...
    public String toString() {
        ...
        StringBuilder stringBuilder = new StringBuilder("ZB_EndDeviceItemShortcuts = [");
    ...
    public boolean equals(Object o) {
        ...
        ZB_EndDeviceItemShortcutsRealmProxy aZB_EndDeviceItemShortcuts = (ZB_EndDeviceItemShortcutsRealmProxy)o;

        String path = realm.getPath();
        String otherPath = aZB_EndDeviceItemShortcuts.realm.getPath();
        if (path != null ? !path.equals(otherPath) : otherPath != null) return false;;

        String tableName = row.getTable().getName();
        String otherTableName = aZB_EndDeviceItemShortcuts.row.getTable().getName();
        if (tableName != null ? !tableName.equals(otherTableName) : otherTableName != null) return false;

        if (row.getIndex() != aZB_EndDeviceItemShortcuts.row.getIndex()) return false;
